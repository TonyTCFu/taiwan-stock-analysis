...
Render 的两个凭证必须在 Render Environment 单独配置，GitHub Actions Secrets 不会自动同步。网关有 30 秒全局冷却，连续点击会收到 429，属于保护机制；响应时间统一使用 Asia/Taipei。2026-08-17 已完成公网验收，Shioaji 与 TWSE MIS 均返回 5/5。
